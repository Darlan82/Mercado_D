# Mercado D. - Cloud Adoption & Modern Architecture

Este repositório contém o material do projeto técnico **Mercado D.**, uma iniciativa fictícia baseada no Microsoft Cloud Adoption Framework (CAF).
...
O projeto usado um Host Aspire mais detalhes em [MercadoD.Host](src/MercadoD.Host/README.md).
